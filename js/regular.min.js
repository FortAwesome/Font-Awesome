...
!function() {
    ...
    [].concat(function(C) {
        ...
        if (C) {
            ...
            return "Map" === (z = "Object" === z && C.constructor ? C.constructor.name : z) || "Set" === z ? Array.from(C) : "Arguments" === z || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(z) ? H(C, c) : void 0;
        }
    }(M) || function() {
    ...
    function n(C, c, z) {
        ...
        "function" != typeof f.hooks.addPack || z ? f.styles[C] = l(l({}, f.styles[C] || {}), M) : f.hooks.addPack(C, t(c)), 
        "fas" === C && n("fa", c);
    }
    var i = {
