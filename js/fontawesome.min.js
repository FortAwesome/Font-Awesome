...
!function() {
    ...
    var T = R((s(c = {}, I, {
        ...
        "fa-light": "fasl",
        "fa-thin": "fast"
    }), b)), W = /fa(s|r|l|t|d|b|k|ss|sr|sl|st)?[\-\ ]/, _ = "fa-layers-text", U = /Font ?Awesome ?([56 ]*)(Solid|Regular|Light|Thin|Duotone|Brands|Free|Pro|Sharp|Kit)?.*/i, X = R((s(c = {}, I, {
        900: "fas",
        400: "far",
        normal: "far",
        300: "fal",
    ...
    u), Pn = null, Sn = {}, Cn = {}, jn = {}, En = {}, zn = {}, Mn = (s(c = {}, I, Object.keys(T[I])), 
    ...
    function wt(n) {
        ...
        n = void 0 === (n = n.observeMutationsRoot) ? h : n, kt = new p(function(n) {
            ...
            gt || (i = Pn, an(n).forEach(function(n) {
                ...
                e = a.getAttribute ? a.getAttribute(S) : null, a = a.getAttribute ? a.getAttribute(C) : null, 
                e && a) ? (a = (t = Wn(en(n.target))).prefix, t = t.iconName, n.target.setAttribute(S, a || i), 
                t && n.target.setAttribute(C, t)) : (t = n.target) && t.classList && t.classList.contains && t.classList.contains(J.replacementClass) && o(n.target));
            }));
        }), y && kt.observe(n, {
            childList: !0,
            attributes: !0,
    ...
    function xt(n) {
        ...
        e = n.innerText, (Cn[a] || {})[e] || Yn(i.prefix, kn(n.innerText)))), !i.iconName && J.autoFetchSvg && n.firstChild && n.firstChild.nodeType === Node.TEXT_NODE && (i.iconName = n.firstChild.data)), 
        i;
    }
    function At(n, t) {
        ...
        hooks: function() {
            return {
                mutationObserverCallbacks: function(n) {
                    return n.treeCallback = St, n.nodeCallback = Ct, n;
                }
            };
        },
        provides: function(n) {
            n.i2svg = function(n) {
                ...
                return St(void 0 === t ? h : t, void 0 === n ? function() {} : n);
    ...
    function Mt(b, p) {
        ...
        return new Promise(function(a, n) {
            ...
            i = u, l && (d = En[l = d], l = Yn("fas", l), (l = d || (l ? {
                ...
                prefix: null,
                iconName: null
            }).iconName && l.prefix && (u = l.iconName, e = l.prefix)), !u || c || f && f.getAttribute(S) === e && f.getAttribute(C) === i ? a() : (b.setAttribute(v, i), 
    ...
    function Rt(n) {
        return n.toLowerCase().split(" ").reduce(function(n, t) {
            ...
            if (e = parseFloat(e), Number.isNaN(e)) return n;
            switch (t) {
              case "grow":
                n.size = n.size + e;
                break;
