...
!function() {
    ...
    var l = (c.navigator || {}).userAgent, v = void 0 === l ? "" : l, z = c, s = h, M = (z.document, 
    ...
    function V(c, v) {
        ...
        "function" != typeof a.hooks.addPack || l ? a.styles[c] = function(z) {
            for (var c = 1; c < arguments.length; c++) {
                var s = null != arguments[c] ? arguments[c] : {}, h = Object.keys(s);
                "function" == typeof Object.getOwnPropertySymbols && (h = h.concat(Object.getOwnPropertySymbols(s).filter(function(c) {
                    return Object.getOwnPropertyDescriptor(s, c).enumerable;
                }))), h.forEach(function(c) {
                    var h, l, v;
                    h = z, v = s[l = c], l in h ? Object.defineProperty(h, l, {
                        value: v,
                        enumerable: !0,
                        configurable: !0,
                        writable: !0
            ...
            return z;
        }({}, a.styles[c] || {}, z) : a.hooks.addPack(c, z), "fas" === c && V("fa", v);
    }
    var f = {
