...
!function() {
    ...
    var z = (c.navigator || {}).userAgent, h = void 0 === z ? "" : z, m = c, v = l, a = (m.document, 
    !!v.documentElement && !!v.head && "function" == typeof v.addEventListener && v.createElement, 
    ~h.indexOf("MSIE") || h.indexOf("Trident/"), "___FONT_AWESOME___"), M = function() {
        try {
            return !1;
        } catch (c) {
            return !1;
    ...
    var s = m || {};
    s[a] || (s[a] = {}), s[a].styles || (s[a].styles = {}), s[a].hooks || (s[a].hooks = {}), 
    s[a].shims || (s[a].shims = []);
    var H = s[a];
    function e(c, h) {
        var l = (2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : {}).skipHooks, z = void 0 !== l && l, m = Object.keys(h).reduce(function(c, l) {
            var z = h[l];
            return !!z.icon ? c[z.iconName] = z.icon : c[l] = z, c;
        }, {});
        "function" != typeof H.hooks.addPack || z ? H.styles[c] = function(m) {
            for (var c = 1; c < arguments.length; c++) {
                var v = null != arguments[c] ? arguments[c] : {}, l = Object.keys(v);
            ...
            return m;
        }({}, H.styles[c] || {}, m) : H.hooks.addPack(c, m), "fas" === c && e("fa", h);
    }
    var V = {
