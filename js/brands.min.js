...
!function() {
    ...
    var H = "___FONT_AWESOME___", e = function() {
        try {
            return !1;
        } catch (c) {
            return !1;
    ...
    a = a || {};
    a[H] || (a[H] = {}), a[H].styles || (a[H].styles = {}), a[H].hooks || (a[H].hooks = {}), 
    a[H].shims || (a[H].shims = []);
    var n = a[H];
    function d(h) {
