...
!function() {
    ...
    var u = (o.navigator || {}).userAgent, d = void 0 === u ? "" : u, g = o, h = s, b = c, u = f, v = !!g.document, p = !!h.documentElement && !!h.head && "function" == typeof h.addEventListener && "function" == typeof h.createElement, y = ~d.indexOf("MSIE") || ~d.indexOf("Trident/"), o = "___FONT_AWESOME___", w = 16, x = "svg-inline--fa", A = "data-fa-i2svg", O = "data-fa-pseudo-element", N = "data-fa-pseudo-element-pending", C = "data-prefix", P = "data-icon", S = "fontawesome-i2svg", E = "async", z = [ "HTML", "HEAD", "STYLE", "SCRIPT" ], j = function() {
        ...
        PRIMARY: "primary",
        SECONDARY: "secondary"
    }, _ = [].concat(l(Object.keys(I)), [ "2xs", "xs", "sm", "lg", "xl", "2xl", "beat", "border", "fade", "beat-fade", "bounce", "flip-both", "flip-horizontal", "flip-vertical", "flip", "fw", "inverse", "layers-counter", "layers-text", "layers", "li", "pull-left", "pull-right", "pulse", "rotate-180", "rotate-270", "rotate-90", "rotate-by", "shake", "spin-pulse", "spin-reverse", "spin", "stack-1x", "stack-2x", "stack", "ul", W.GROUP, W.SWAP_OPACITY, W.PRIMARY, W.SECONDARY ]).concat(s.map(function(n) {
        return "".concat(n, "x");
    ...
    function Sn(n, t) {
        ...
        return t !== n || "" === a || ~_.indexOf(a) ? null : a;
    }
    function En() {
        function n(e) {
        ...
        var i = "far" in hn || B.autoFetchSvg, t = dn(yn, function(n, t) {
        ...
        On = t.names, Nn = t.unicodes, wn = Ln(B.styleDefault);
    }
    function zn(n, t) {
        return (xn[n] || {})[t];
    }
    ...
    function Yn(n, t) {
        var t = (1 < arguments.length && void 0 !== t ? t : {}).skipLookups, e = void 0 !== t && t, i = null, n = n.reduce(function(n, t) {
            var a = Sn(B.familyPrefix, t);
            return hn[t] ? (t = kn.includes(t) ? Y[t] : t, i = t, n.prefix = t) : -1 < Pn.indexOf(t) ? (i = t, 
            n.prefix = Ln(t)) : a ? n.iconName = a : t !== B.replacementClass && n.rest.push(t), 
            ...
            "far" !== n.prefix || hn.far || !hn.fas || B.autoFetchSvg || (n.prefix = "fas")), 
            n;
        }, In());
    ...
    function _n(n) {
        ...
        if (t) return t = jn(n, t) || t, mn(Un.definitions, n, t) || mn(sn.styles, n, t);
    }
    var Un = new c(), Xn = {
        noAuto: function() {
            B.autoReplaceSvg = !1, B.observeMutations = !1, Hn("noAuto");
        },
        config: B,
        dom: {
            i2svg: function() {
            ...
            watch: function() {
                ...
                !1 === B.autoReplaceSvg && (B.autoReplaceSvg = !0), B.observeMutations = !0, ln(function() {
                    Bn({
        ...
        parse: {
            icon: function(n) {
                ...
                if ("string" == typeof n && (-1 < n.indexOf("".concat(B.familyPrefix, "-")) || n.match(R))) {
                    t = Yn(n.split(" "), {
                        skipLookups: !0
                    });
                    return {
        ...
        (0 < Object.keys(sn.styles).length || B.autoFetchSvg) && p && B.autoReplaceSvg && Xn.dom.i2svg({
            node: n
        });
    };
    function qn(t, n) {
    ...
    function Vn(n) {
        var t = n.icons, a = t.main, e = t.mask, i = n.prefix, r = n.iconName, o = n.transform, s = n.symbol, c = n.title, f = n.maskId, l = n.titleId, u = n.extra, m = n.watchable, d = void 0 !== m && m, b = e.found ? e : a, t = b.width, n = b.height, m = "fak" === i, b = [ B.replacementClass, r ? "".concat(B.familyPrefix, "-").concat(r) : "" ].filter(function(n) {
        ...
        h = v.children, y = v.attributes, v = !0 === (v = v.symbol) ? "".concat(p, "-").concat(B.familyPrefix, "-").concat(g) : v, 
        [ {
            tag: "svg",
            attributes: {
                style: "display: none;"
    ...
    function Jn(n) {
        ...
        return {
            ...
            icon: Array.isArray(n) ? {
                tag: "g",
                attributes: {
                    class: "".concat(B.familyPrefix, "-").concat(W.GROUP)
                },
                children: [ {
                    tag: "path",
                    attributes: {
                        class: "".concat(B.familyPrefix, "-").concat(W.SECONDARY),
                        fill: "currentColor",
                        d: n[0]
                    }
                }, {
                    tag: "path",
                    attributes: {
                        class: "".concat(B.familyPrefix, "-").concat(W.PRIMARY),
                        fill: "currentColor",
                        d: n[1]
                    }
                } ]
    ...
    function Zn(i, r) {
        var o = r;
        return "fa" === r && null !== B.styleDefault && (r = wn), new Promise(function(n, t) {
            var a, e;
            Wn("missingIconAbstract");
            if ("fa" === o && (e = Mn(i) || {}, i = e.iconName || i, r = e.prefix || r), i && r && Kn[r] && Kn[r][i]) return n(Jn(Kn[r][i]));
            a = i, e = r, j || B.showMissingIcons || !a || console.error('Icon with name "'.concat(a, '" and prefix "').concat(e, '" is missing.')), 
            n(k(k({}, Qn), {}, {
                icon: B.showMissingIcons && i && Wn("missingIconAbstract") || {}
            }));
        });
    }
    function $n() {}
    ...
    var tt = B.measurePerformance && u && u.mark && u.measure ? u : {
        mark: $n,
        measure: $n
    }, at = 'FA "6.1.2"', et = {
        begin: function(n) {
    ...
    var ct = {
        replace: function(n) {
            ...
            }), null === t.getAttribute(A) && B.keepOriginalSource ? (n = h.createComment((n = " ".concat((n = t).outerHTML, " "), 
            n = "".concat(n, "Font Awesome fontawesome.com "))), t.parentNode.replaceChild(n, t)) : t.remove());
        },
        nest: function(n) {
            var t = n[0], a = n[1];
            if (~Z(t).indexOf(B.replacementClass)) return ct.replace(n);
            var e = new RegExp("".concat(B.familyPrefix, "-.*"));
            delete a[0].attributes.id, a[0].attributes.class && (n = a[0].attributes.class.split(" ").reduce(function(n, t) {
                return (t === B.replacementClass || t.match(e) ? n.toSvg : n.toNode).push(t), n;
            }, {
                toNode: [],
                toSvg: []
    ...
    function lt(a, n) {
        ...
        0 === a.length ? e() : (B.mutateApproach === E ? g.requestAnimationFrame || ft : ft)(function() {
            var n = !0 !== B.autoReplaceSvg && ct[B.autoReplaceSvg] || ct.replace, t = et.begin("mutate");
            a.map(n), t(), e();
        });
    }
    var ut = !1;
    ...
    function vt(n) {
        var r, o, t, s;
        b && B.observeMutations && (t = n.treeCallback, r = void 0 === t ? it : t, t = n.nodeCallback, 
        ...
        n = void 0 === (n = n.observeMutationsRoot) ? h : n, bt = new b(function(n) {
            ...
            ut || (i = wn, Q(n).forEach(function(n) {
                var t, a, e;
                "childList" === n.type && 0 < n.addedNodes.length && !rt(n.addedNodes[0]) && (B.searchPseudoElements && s(n.target), 
                r(n.target)), "attributes" === n.type && n.target.parentNode && B.searchPseudoElements && s(n.target.parentNode), 
                ...
                t && n.target.setAttribute(P, t)) : (t = n.target) && t.classList && t.classList.contains && t.classList.contains(B.replacementClass) && o(n.target));
            }));
        }), p && bt.observe(n, {
            childList: !0,
            attributes: !0,
    ...
    function pt(n) {
        ...
        e = n.innerText, (An[a] || {})[e] || zn(i.prefix, vn(n.innerText)))), !i.iconName && B.autoFetchSvg && n.firstChild && n.firstChild.nodeType === Node.TEXT_NODE && (i.iconName = n.firstChild.data)), 
        i;
    }
    function gt(n, t) {
        ...
        }, {}), e = s.getAttribute("title"), s = s.getAttribute("data-fa-title-id"), B.autoA11y && (e ? t["aria-labelledby"] = "".concat(B.replacementClass, "-title-").concat(s || J()) : (t["aria-hidden"] = "true", 
    ...
    var ht = sn.styles;
    function yt(n) {
        var t = "nest" === B.autoReplaceSvg ? gt(n, {
            styleParser: !1
        }) : gt(n);
    ...
    function kt(n) {
        ...
        var t = h.documentElement.classList, a = B.autoFetchSvg ? Object.keys(M) : Object.keys(ht);
        a.includes("fa") || a.push("fa");
        var o = [ ".".concat(T, ":not([").concat(A, "])") ].concat(a.map(function(n) {
        ...
        if (n) {
            ...
            return qn(k({
                ...
                return Hn("beforeDOMElementCreation", {
                    iconDefinition: n,
                    params: t
                }), B.autoA11y && (s ? l["aria-labelledby"] = "".concat(B.replacementClass, "-title-").concat(c || J()) : (l["aria-hidden"] = "true", 
    ...
    var o = {
        mixout: function() {
            return {
                icon: (e = xt, function(n) {
                    var t = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {}, a = (n || {}).icon ? n : _n(n || {}), n = (n = t.mask) && ((n || {}).icon ? n : _n(n || {}));
                    return e(a, k(k({}, t), {}, {
                        mask: n
                    }));
                })
                ...
                layer: function(n) {
                    ...
                    return qn({
                        ...
                        return n(function(n) {
                            ...
                            tag: "span",
                            attributes: {
                                class: [ "".concat(B.familyPrefix, "-layers") ].concat(l(e)).join(" ")
                            },
                            children: t
                        } ];
                    });
                    ...
                    return qn({
                        ...
                        return Hn("beforeDOMElementCreation", {
                            ...
                            extra: {
                                attributes: c,
                                styles: f,
                                classes: [ "".concat(B.familyPrefix, "-layers-counter") ].concat(l(s))
                            }
                    ...
                    return qn({
                        ...
                        return Hn("beforeDOMElementCreation", {
                            ...
                            extra: {
                                attributes: o,
                                styles: s,
                                classes: [ "".concat(B.familyPrefix, "-layers-text") ].concat(l(r))
                            }
                        });
                    });
                }
        ...
        provides: function(n) {
            n.generateLayersText = function(n, t) {
                ...
                s = t.height / a), B.autoA11y && !e && (r.attributes["aria-hidden"] = "true"), Promise.resolve([ n, Gn({
                    content: n.innerHTML,
                    width: o,
                    height: s,
                    transform: i,
    ...
    function Nt(b, v) {
        ...
        return new Promise(function(a, n) {
            ...
            t = Ot[0] <= c && c <= Ot[1], {
                ...
                isSecondary: t || c
            })).value, c = d.isSecondary, d = u[0].startsWith("FontAwesome"), u = zn(e, t), 
            i = u, d && (t = Nn[d = t], d = zn("fas", d), (d = t || (d ? {
                prefix: "fas",
                iconName: d
            } : null) || {
                prefix: null,
    ...
    function Pt(n) {
        return !(n.parentNode === document.head || ~z.indexOf(n.tagName.toUpperCase()) || n.getAttribute(O) || n.parentNode && "svg" === n.parentNode.tagName);
    }
    function St(i) {
    ...
    It = {
        ...
        provides: function(n) {
            n.pseudoElements2svg = function(n) {
                n = n.node;
                B.searchPseudoElements && St(void 0 === n ? h : n);
            };
        }
    }, {
        mixout: function() {
        ...
        hooks: function() {
            return {
                ...
                watch: function(n) {
                    ...
                    zt ? dt() : vt(Fn("mutationObserverCallbacks", {
        ...
        v && (g.FontAwesome || (g.FontAwesome = Xn), ln(function() {
            Bn(), Hn("bootstrap");
        })), sn.hooks = k(k({}, sn.hooks), {}, {
            addPack: function(n, t) {
                sn.styles[n] = k(k({}, sn.styles[n] || {}), t), En(), Bn();
            },
            addPacks: function(n) {
            ...
            addShims: function(n) {
                var t;
                (t = sn.shims).push.apply(t, l(n)), En(), Bn();
            }
        });
    });
}();