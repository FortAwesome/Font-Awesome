...
!function() {
    ...
    var l = (c.navigator || {}).userAgent, h = void 0 === l ? "" : l, v = c, m = z, a = (v.document, 
    ...
    function f(c, h) {
        ...
        "function" != typeof H.hooks.addPack || l ? H.styles[c] = function(v) {
            ...
            return v;
        }({}, H.styles[c] || {}, v) : H.hooks.addPack(c, v), "fas" === c && f("fa", h);
    }
    var e = {
