...
!function() {
    ...
    var C = "___FONT_AWESOME___", H = function() {
        try {
            return !1;
        } catch (c) {
            return !1;
    ...
    [].concat(function(c) {
        ...
        if (c) {
            if ("string" == typeof c) return s(c, z);
            var l = Object.prototype.toString.call(c).slice(8, -1);
            return "Map" === (l = "Object" === l && c.constructor ? c.constructor.name : l) || "Set" === l ? Array.from(c) : "Arguments" === l || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(l) ? s(c, z) : void 0;
        }
    }(h) || function() {
    ...
    m = m || {};
    m[C] || (m[C] = {}), m[C].styles || (m[C].styles = {}), m[C].hooks || (m[C].hooks = {}), 
    m[C].shims || (m[C].shims = []);
    var L = m[C];
    function f(h) {
    ...
    function r(c, z, l) {
        ...
        "function" != typeof L.hooks.addPack || l ? L.styles[c] = M(M({}, L.styles[c] || {}), h) : L.hooks.addPack(c, f(z)), 
        "fas" === c && r("fa", z);
    }
    var t = {
