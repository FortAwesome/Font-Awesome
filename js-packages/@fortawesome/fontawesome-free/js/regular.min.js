...
!function() {
    ...
    var h = (c.navigator || {}).userAgent, l = void 0 === h ? "" : h, v = c, m = z, s = (v.document, 
    !!m.documentElement && !!m.head && "function" == typeof m.addEventListener && m.createElement, 
    ~l.indexOf("MSIE") || l.indexOf("Trident/"), "___FONT_AWESOME___"), M = function() {
        try {
            return !1;
        } catch (c) {
            return !1;
    ...
    var H = a[s];
    function V(c, l) {
        var z = (2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : {}).skipHooks, h = void 0 !== z && z, v = Object.keys(l).reduce(function(c, z) {
            var h = l[z];
