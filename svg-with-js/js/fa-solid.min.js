...
!function() {
    ...
    var m = l || {};
    m[z] || (m[z] = {}), m[z].styles || (m[z].styles = {}), m[z].hooks || (m[z].hooks = {}), 
    m[z].shims || (m[z].shims = []);
    var V = m[z], a = Object.assign || function(c) {
    ...
    !function(c) {
        ...
        !function c(h, v) {
            ...
            "function" == typeof V.hooks.addPack ? V.hooks.addPack(h, l) : V.styles[h] = a({}, V.styles[h] || {}, l), 
            "fas" === h && c("fa", v);
        }("fas", f);
    });
}();