...
!function() {
    ...
    var h = (c.navigator || {}).userAgent, v = void 0 === h ? "" : h, l = c, z = (~v.indexOf("MSIE") || v.indexOf("Trident/"), 
    "___FONT_AWESOME___"), H = function() {
        try {
            return !1;
        } catch (c) {
            return !1;
    ...
    var a = l || {};
    a[z] || (a[z] = {}), a[z].styles || (a[z].styles = {}), a[z].hooks || (a[z].hooks = {}), 
    a[z].shims || (a[z].shims = []);
    var V = a[z], m = Object.assign || function(c) {
    ...
    !function(c) {
        ...
        !function c(h, l) {
            ...
            "function" == typeof V.hooks.addPack ? V.hooks.addPack(h, v) : V.styles[h] = m({}, V.styles[h] || {}, v), 
            "fas" === h && c("fa", l);
        }("fas", f);
    });
}();