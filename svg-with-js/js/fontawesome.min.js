...
!function() {
    ...
    function V(t, e) {
        ...
        return i !== t || "" === a || (n = a, ~C.indexOf(n)) ? null : a;
    }
    function q(t) {
    ...
    function Ct(t, e) {
        ...
        0 === t.length ? n() : (s.requestAnimationFrame || function(t) {
            ...
            var e = !0 === S.autoReplaceSvg ? zt.replace : zt[S.autoReplaceSvg] || zt.replace, r = ft.begin("mutate");
            t.map(e), r(), n();
        });
    }
    var Nt = !1;
                ...
                if (l) {
                    ...
                    Mt = new l(function(t) {
                        Nt || Y(t).forEach(function(t) {
                            ...
                            "attributes" === t.type && kt(t.target) && ~z.indexOf(t.attributeName)) if ("class" === t.attributeName) {
